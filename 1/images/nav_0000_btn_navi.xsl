...
<xsl:template match="params">
	...
	<xsl:variable name="font-color-over-fixed">
		<xsl:call-template name="fix-color">
			<xsl:with-param name="color" select="font_color_over"/>
		</xsl:call-template>
	</xsl:variable>
	...
	<xsl:variable name="_btn_text">
		<xsl:choose>
			<xsl:when test="role='thisslide'"><xsl:value-of select="text_thisslide"/></xsl:when>
			<xsl:when test="role='nextslide'"><xsl:value-of select="text_nextslide"/></xsl:when>
			<xsl:when test="role='prevslide'"><xsl:value-of select="text_prevslide"/></xsl:when>
			<xsl:when test="role='firstslide'"><xsl:value-of select="text_firstslide"/></xsl:when>
			<xsl:when test="role='lastslide'"><xsl:value-of select="text_lastslide"/></xsl:when>
			<xsl:when test="role='nextframe'"><xsl:value-of select="text_nextframe"/></xsl:when>
			<xsl:when test="role='prevframe'"><xsl:value-of select="text_prevframe"/></xsl:when>
			<xsl:when test="role='firstframe'"><xsl:value-of select="text_firstframe"/></xsl:when>
			<xsl:when test="role='lastframe'"><xsl:value-of select="text_lastframe"/></xsl:when>
			<xsl:when test="role='selectedslide'"><xsl:value-of select="text_selectedslide"/></xsl:when>
			<xsl:when test="role='selectedframe'"><xsl:value-of select="text_selectedframe"/></xsl:when>
			<xsl:when test="role='closemodule'"><xsl:value-of select="text_closemodule"/></xsl:when>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="_btn_alt_enabled">
		<xsl:choose>
			<xsl:when test="role='thisslide'"><xsl:value-of select="alt_enabled_thisslide"/></xsl:when>
			<xsl:when test="role='nextslide'"><xsl:value-of select="alt_enabled_nextslide"/></xsl:when>
			<xsl:when test="role='prevslide'"><xsl:value-of select="alt_enabled_prevslide"/></xsl:when>
			<xsl:when test="role='firstslide'"><xsl:value-of select="alt_enabled_firstslide"/></xsl:when>
			<xsl:when test="role='lastslide'"><xsl:value-of select="alt_enabled_lastslide"/></xsl:when>
			<xsl:when test="role='nextframe'"><xsl:value-of select="alt_enabled_nextframe"/></xsl:when>
			<xsl:when test="role='prevframe'"><xsl:value-of select="alt_enabled_prevframe"/></xsl:when>
			<xsl:when test="role='firstframe'"><xsl:value-of select="alt_enabled_firstframe"/></xsl:when>
			<xsl:when test="role='lastframe'"><xsl:value-of select="alt_enabled_lastframe"/></xsl:when>
			<xsl:when test="role='selectedslide'"><xsl:value-of select="alt_enabled_selectedslide"/></xsl:when>
			<xsl:when test="role='selectedframe'"><xsl:value-of select="alt_enabled_selectedframe"/></xsl:when>
			<xsl:when test="role='closemodule'"><xsl:value-of select="alt_enabled_closemodule"/></xsl:when>
		</xsl:choose>
	</xsl:variable>
	<xsl:variable name="_btn_alt_disabled">
		<xsl:choose>
			<xsl:when test="role='thisslide'"><xsl:value-of select="alt_disabled_thisslide"/></xsl:when>
			<xsl:when test="role='nextslide'"><xsl:value-of select="alt_disabled_nextslide"/></xsl:when>
			<xsl:when test="role='prevslide'"><xsl:value-of select="alt_disabled_prevslide"/></xsl:when>
			<xsl:when test="role='firstslide'"><xsl:value-of select="alt_disabled_firstslide"/></xsl:when>
			<xsl:when test="role='lastslide'"><xsl:value-of select="alt_disabled_lastslide"/></xsl:when>
			<xsl:when test="role='nextframe'"><xsl:value-of select="alt_disabled_nextframe"/></xsl:when>
			<xsl:when test="role='prevframe'"><xsl:value-of select="alt_disabled_prevframe"/></xsl:when>
			<xsl:when test="role='firstframe'"><xsl:value-of select="alt_disabled_firstframe"/></xsl:when>
			<xsl:when test="role='lastframe'"><xsl:value-of select="alt_disabled_lastframe"/></xsl:when>
			<xsl:when test="role='selectedslide'"><xsl:value-of select="alt_disabled_selectedslide"/></xsl:when>
			<xsl:when test="role='selectedframe'"><xsl:value-of select="alt_disabled_selectedframe"/></xsl:when>
			<xsl:when test="role='closemodule'"><xsl:value-of select="alt_disabled_closemodule"/></xsl:when>
		</xsl:choose>
	</xsl:variable>
	...
	<xsl:variable name="_css_font">
		font-family: <xsl:value-of select="$_btn_font"/>; font-size: <xsl:value-of select="font_size"/>px; color: <xsl:value-of select="$font-color-fixed"/>; <xsl:if test="text_shadow_strength!='none'">text-shadow: <xsl:value-of select="$_text_shadow"/>;</xsl:if><xsl:value-of select="$_css_font_style"/>
	</xsl:variable>
		...
		<xsl:choose>
			...
			<xsl:when test="btn_type='html'">
				<div class="rule">
					...
					<xsl:if test="number(border_width)!=0">
						<span class="rule-static">border-style: <xsl:value-of select="border_style"/>; border-width: <xsl:value-of select="border_width"/>px; border-color: <xsl:value-of select="$border-color-fixed"/>;</span>
					</xsl:if>
				...
				<div class="rule">
					<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-idle</xsl:attribute>
					<xsl:if test="bg_type!='transparent'">
						<span class="rule-static"><xsl:value-of select="$_css_bg_color"/></span>
					</xsl:if>
					<xsl:if test="bg_type='auto' or bg_type='custom'">
						<span class="rule-dynamic">
							<xsl:attribute name="data-type">linear-gradient</xsl:attribute>
							<xsl:attribute name="data-angle">0</xsl:attribute>
							<xsl:attribute name="data-colors"><xsl:value-of select="$bg-color-fixed"/>|0;<xsl:value-of select="$_btn_gradient_color"/>|100</xsl:attribute>
						</span>
					</xsl:if>
				</div>
				<div class="rule">
					<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-over</xsl:attribute>
					<span class="rule-static">background-color: <xsl:value-of select="$_btn_gradient_color"/>;</span>
					<xsl:if test="bg_type='auto' or bg_type='custom'">
						<span class="rule-dynamic">
							<xsl:attribute name="data-type">linear-gradient</xsl:attribute>
							<xsl:attribute name="data-angle">0</xsl:attribute>
							<xsl:attribute name="data-colors"><xsl:value-of select="$_btn_gradient_color"/>|0;<xsl:value-of select="$bg-color-fixed"/>|100</xsl:attribute>
						</span>
					</xsl:if>
				</div>
				<div class="rule">
					<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-disabled</xsl:attribute>
					<span class="rule-static"><xsl:choose><xsl:when test="bg_type='transparent'">background-color: transparent; </xsl:when><xsl:otherwise>background-color: <xsl:value-of select="$bg-color-fixed"/>;</xsl:otherwise></xsl:choose></span>
				</div>
				<div class="rule">
					<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-btn-bg</xsl:attribute>
					<span class="rule-static">width: <xsl:value-of select="$_btn_inner_w"/>px; height: <xsl:value-of select="$_btn_inner_h"/>px;</span>
				</div>
				<xsl:if test="content='image' or content='textimage'">
					<div class="rule">
						<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-idle .cl-btn-bg</xsl:attribute>
						<span class="rule-static">background-image: url(<xsl:value-of select="bg_img_1"/>); background-position: <xsl:value-of select="bg_position"/> center; background-repeat: no-repeat;</span>
					</div>
					<div class="rule">
						<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-over .cl-btn-bg</xsl:attribute>
						<span class="rule-static">background-image: url(<xsl:value-of select="bg_img_2"/>); background-position: <xsl:value-of select="bg_position"/> center; background-repeat: no-repeat;</span>
					</div>
					<div class="rule">
						<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-disabled .cl-btn-bg</xsl:attribute>
						<span class="rule-static">background-image: url(<xsl:value-of select="bg_img_3"/>); background-position: <xsl:value-of select="bg_position"/> center; background-repeat: no-repeat;</span>
					</div>
				</xsl:if>
				<div class="rule">
					<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-btn-table</xsl:attribute>
					<span class="rule-static">width: <xsl:value-of select="$_btn_inner_w"/>px; height: <xsl:value-of select="$_btn_inner_h"/>px;</span>
				</div>
				<div class="rule">
					<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-btn-table .cl-btn-table-content</xsl:attribute>
					<span class="rule-static">width: <xsl:value-of select="$_btn_inner_w"/>px; height: <xsl:value-of select="$_btn_inner_h"/>px; text-align: <xsl:value-of select="text_position"/>; padding: 0 <xsl:value-of select="text_margin_right"/>px 0 <xsl:value-of select="text_margin_left"/>px; <xsl:value-of select="$_css_font"/></span>
				</div>
				<div class="rule">
					<xsl:attribute name="data-name">#<xsl:value-of select="$objectID"/> .cl-over .cl-btn-table-content</xsl:attribute>
					<span class="rule-static">color: <xsl:value-of select="$font-color-over-fixed"/> !important;</span>
				</div>
			</xsl:when>
		</xsl:choose>
	</div>
	<div>
		...
		<xsl:choose>
			<xsl:when test="btn_type='image'">
				<div>
					<xsl:attribute name="class">cl-btn cl-btn-img cl-idle</xsl:attribute>
					<xsl:attribute name="title"><xsl:value-of select="$_btn_alt_enabled"/></xsl:attribute>
					<xsl:attribute name="data-title-enabled"><xsl:value-of select="$_btn_alt_enabled"/></xsl:attribute>
					<xsl:attribute name="data-title-disabled"><xsl:value-of select="$_btn_alt_disabled"/></xsl:attribute>
					<img>
			...
			<xsl:when test="btn_type='html'">
				<div>
					<xsl:attribute name="class">cl-btn cl-btn-html cl-idle</xsl:attribute>
					<xsl:attribute name="title"><xsl:value-of select="$_btn_alt_enabled"/></xsl:attribute>
					<xsl:attribute name="data-title-enabled"><xsl:value-of select="$_btn_alt_enabled"/></xsl:attribute>
					<xsl:attribute name="data-title-disabled"><xsl:value-of select="$_btn_alt_disabled"/></xsl:attribute>
					<div>
						<xsl:attribute name="class">cl-btn-bg</xsl:attribute>
						<table>
							<xsl:attribute name="class">cl-btn-table</xsl:attribute>
							<tr>
								<td>
									<xsl:attribute name="class">cl-btn-table-content</xsl:attribute>
									<xsl:choose>
										<xsl:when test="content='image'">&#160;</xsl:when>
										<xsl:otherwise><xsl:value-of select="$_btn_text"/></xsl:otherwise>
									</xsl:choose>
								</td>
							</tr>
						</table>
