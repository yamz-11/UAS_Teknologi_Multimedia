...
<xsl:template match="params">
	...
	<div>
		<xsl:attribute name="class">clo-basic_textbox cl-container cl-theme-<xsl:value-of select="$theme"/></xsl:attribute>
		<xsl:choose>
			<xsl:when test="$theme='simple'">
				...
				<xsl:if test="number($simple-box-min-height)=1">
					<div>
						<xsl:attribute name="class">cl-object-warning</xsl:attribute>
						<xsl:attribute name="style">width: <xsl:value-of select="$width"/>px;</xsl:attribute>
						<xsl:value-of select="hidden.text_area_warning"/>
					</div>
				</xsl:if>
			</xsl:when>
			<xsl:when test="$theme='light'">
				...
				<xsl:if test="number($light-box-min-height)=1">
					<div>
						<xsl:attribute name="class">cl-object-warning</xsl:attribute>
						<xsl:attribute name="style">width: <xsl:value-of select="$width"/>px;</xsl:attribute>
						<xsl:value-of select="hidden.text_area_warning"/>
			...
			<xsl:when test="$theme='standard'">
				...
				<xsl:if test="number($standard-box-min-height)=1">
					<div>
						<xsl:attribute name="class">cl-object-warning</xsl:attribute>
						<xsl:attribute name="style">width: <xsl:value-of select="$width"/>px;</xsl:attribute>
						<xsl:value-of select="hidden.text_area_warning"/>
			...
			<xsl:when test="$theme='curve'">
				...
				<xsl:if test="number($curve-box-min-height)=1">
					<div>
						<xsl:attribute name="class">cl-object-warning</xsl:attribute>
						<xsl:attribute name="style">width: <xsl:value-of select="$width"/>px;</xsl:attribute>
						<xsl:value-of select="hidden.text_area_warning"/>
			...
			<xsl:when test="$theme='gradient'">
				...
				<xsl:if test="number($gradient-box-min-height)=1">
					<div>
						<xsl:attribute name="class">cl-object-warning</xsl:attribute>
						<xsl:attribute name="style">width: <xsl:value-of select="$width"/>px;</xsl:attribute>
						<xsl:value-of select="hidden.text_area_warning"/>
			...
			<xsl:when test="$theme='relief'">
				...
				<xsl:if test="number($relief-box-min-height)=1">
					<div>
						<xsl:attribute name="class">cl-object-warning</xsl:attribute>
						<xsl:attribute name="style">width: <xsl:value-of select="$width"/>px;</xsl:attribute>
						<xsl:value-of select="hidden.text_area_warning"/>
			...
			<xsl:when test="$theme='text'">
				...
				<xsl:if test="number($text-box-min-height)=1">
					<div>
						<xsl:attribute name="class">cl-object-warning</xsl:attribute>
						<xsl:attribute name="style">width: <xsl:value-of select="$width"/>px;</xsl:attribute>
						<xsl:value-of select="hidden.text_area_warning"/>
			...
			<xsl:when test="$theme='custom'">
				...
				<xsl:if test="number($custom-box-min-height)=1">
					<div>
						<xsl:attribute name="class">cl-object-warning</xsl:attribute>
						<xsl:attribute name="style">width: <xsl:value-of select="$width"/>px;</xsl:attribute>
						<xsl:value-of select="hidden.text_area_warning"/>
